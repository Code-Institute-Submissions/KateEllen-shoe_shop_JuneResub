"""
Django settings for FunkyFeet project.
...
MEDIA_URL = 'https://funky-feet.s3.amazonaws.com/media/'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'funkyfeetshoes1@gmail.com'
else:
